...
process.load("SimG4Core.CheckSecondary.test.PbWO4Geom_cfi")
...
process.g4SimHits.Physics = cms.PSet(
    ...
    type = cms.string('SimG4Core/Physics/FTF_BIC'),
    DummyEMPhysics = cms.bool(False)
)
process.g4SimHits.Watchers = cms.VPSet(cms.PSet(
    CheckSecondary = cms.PSet(
        SaveInFile = cms.untracked.string('PbWO4FTF_BIC_pip_300.0GeV.root'),
        Verbosity = cms.untracked.int32(0),
