...
process.load("SimG4Core.CheckSecondary.test.CuTarget_cfi")
...
process.source = cms.Source("FlatRandomEGunSource",
    PGunParameters = cms.untracked.PSet(
        ...
        MinE = cms.untracked.double(6.0729),
        MinPhi = cms.untracked.double(1.57079632679),
        MaxE = cms.untracked.double(6.0729)
    ),
...
process.g4SimHits.Watchers = cms.VPSet(cms.PSet(
    CheckSecondary = cms.PSet(
        SaveInFile = cms.untracked.string('CuLEP6.0GeV.root'),
        Verbosity = cms.untracked.int32(0),
